...
export const metadata: Metadata = {
  title: `${DEFAULT_LOCATION.city} - Прогноз погоды`,
  description: `Прогноз погоды в ${DEFAULT_LOCATION.city} с текущими условиями, ветром, качеством воздуха и прогнозом на ближайшие дни.`,
}
